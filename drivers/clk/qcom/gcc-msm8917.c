...
/*
 * Copyright 2021 Avishek Sen <x0rzavi@gmail.com>
 */
...
static struct clk_regmap gpll0_sleep = {
	.enable_reg = 0x45008,
	.enable_mask = BIT(23),
...
static struct clk_regmap gpll0_ao_vote = {
	.enable_reg = 0x45000,
	.enable_mask = BIT(0),
	.hw.init = &(struct clk_init_data){
		.name = "gpll0_vote",
...
static const struct parent_map gcc_xo_gpll0_gpll6_gpll4o_map[] = {
	{ P_XO, 0 },
	{ P_GPLL0, 1 },
	{ P_GPLL6, 2 },
	{ P_GPLL4_OUT, 3 },
...
static const struct clk_parent_data gcc_xo_gpll0_gpll6_gpll4o_parent_data[] = {
	{ .fw_name = "xo" },
	{ .hw = &gpll0_vote.hw },
	{ .hw = &gpll6_vote.hw },
	{ .hw = &gpll4_vote.hw },
...
static const struct parent_map gcc_xo_gpll0_gpll6a_gpll3_map[] = {
	{ P_XO, 0 },
	{ P_GPLL0, 1 },
	{ P_GPLL6_AUX, 3 },
	{ P_GPLL3, 2 },
...
static const struct clk_parent_data gcc_xo_gpll0_gpll6a_gpll3_parent_data[] = {
	{ .fw_name = "xo" },
	{ .hw = &gpll0_vote.hw },
	{ .hw = &gpll6_vote.hw },
	{ .hw = &gpll3.clkr.hw },
...
static const struct parent_map gcc_xo_dsi00_dsi10_map[] = {
	{ P_XO, 0 },
	{ P_DSI0_0PHYPLL, 1 },
	{ P_DSI1_0PHYPLL, 3 },
};

static const struct clk_parent_data gcc_xo_dsi00_dsi10_parent_data[] = {
	{ .fw_name = "xo" },
	{ .fw_name = "dsi0_0phypll"},
	{ .fw_name = "dsi1_0phypll"},
};

static const struct parent_map gcc_xo_dsi11_dsi01_map[] = {
	{ P_XO, 0 },
	{ P_DSI1_1PHYPLL, 1 },
	{ P_DSI0_1PHYPLL, 3 },
};

static const struct clk_parent_data gcc_xo_dsi11_dsi01_parent_data[] = {
	{ .fw_name = "xo" },
	{ .fw_name = "dsi1_1phypll"},
	{ .fw_name = "dsi0_1phypll"},
};

static const struct parent_map gcc_xo_gpll0_dsi0_map[] = {
	{ P_XO, 0 },
	{ P_GPLL0, 1 },
	{ P_DSI0_PHYPLL, 2 },
};

static const struct clk_parent_data gcc_xo_gpll0_dsi0_parent_data[] = {
	{ .fw_name = "xo" },
	{ .hw = &gpll0_vote.hw },
	{ .fw_name = "dsi0_phypll"},
};
...
static const struct parent_map gcc_xo_gpll6o_map[] = {
	{ P_XO, 0 },
	{ P_GPLL6_OUT_MAIN, 1 },
};

static const struct clk_parent_data gcc_xo_gpll6o_parent_data[] = {
	{ .fw_name = "xo" },
	{ .hw = &gpll6_vote.hw },
};
...
static const struct freq_tbl ftbl_csi0_2_clk_src[] = {
	F(100000000, P_GPLL0, 8, 0, 0),
...
static const struct freq_tbl ftbl_vcodec0_clk_src[] = {
	...
	F( 329140000, P_GPLL4_OUT, 3.5, 0, 0),
...
static struct clk_rcg2 vcodec0_clk_src = {
	...
	.mnd_width = 8,
	.hid_width = 5,
	.parent_map = gcc_xo_gpll0_gpll6_gpll4o_map,
	.freq_tbl = ftbl_vcodec0_clk_src,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "vcodec0_clk_src",
		.parent_data = gcc_xo_gpll0_gpll6_gpll4o_parent_data,
		.num_parents = 4,
		.ops = &clk_rcg2_ops,
	},
};

static const struct freq_tbl ftbl_vfe0_1_clk_src[] = {
	F(  50000000, P_GPLL0, 16, 0, 0),
	F(  80000000, P_GPLL0, 10, 0, 0),
	F( 100000000, P_GPLL0, 8, 0, 0),
...
static struct freq_tbl ftbl_oxili_gfx3d_clk_src[] = {
	F( 19200000, P_XO, 1, 0, 0),
	F( 50000000, P_GPLL0, 16, 0, 0),
	F( 80000000, P_GPLL0, 10, 0, 0),
	F( 100000000, P_GPLL0, 8, 0, 0),
...
static struct clk_rcg2 gfx3d_clk_src = {
	...
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = gcc_xo_gpll0_gpll6a_gpll3_map,
	.freq_tbl = ftbl_oxili_gfx3d_clk_src,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "gfx3d_clk_src",
		.parent_data = gcc_xo_gpll0_gpll6a_gpll3_parent_data,
		.num_parents = 4,
...
static const struct freq_tbl ftbl_blsp1_2_qup1_4_i2c_apps_clk_src[] = {
	F(19200000, P_XO, 1, 0, 0),
	F(50000000, P_GPLL0, 16, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_blsp1_2_qup1_4_spi_apps_clk_src[] = {
...
static const struct freq_tbl ftbl_blsp1_2_uart1_2_apps_clk_src[] = {
...
static struct clk_rcg2 blsp1_uart1_apps_clk_src = {
	...
	.hid_width = 5,
	.parent_map = gcc_xo_gpll0_map,
	.freq_tbl = ftbl_blsp1_2_uart1_2_apps_clk_src,
	.clkr.hw.init = &(struct clk_init_data){
...
static const struct freq_tbl ftbl_mclk0_2_clk_src[] = {
	F(19200000, P_XO, 1, 0, 0),
...
static const struct freq_tbl ftbl_esc0_1clk_src[] = {
	F(19200000, P_XO, 1, 0, 0),
	{ }
};
...
static struct clk_rcg2 byte0_clk_src = {
	...
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = gcc_xo_dsi00_dsi10_map,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "byte0_clk_src",
		.parent_data = gcc_xo_dsi00_dsi10_parent_data,
		.num_parents = 3,
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_byte2_ops,
	},
...
static struct clk_rcg2 byte1_clk_src = {
	...
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = gcc_xo_dsi11_dsi01_map,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "byte1_clk_src",
		.parent_data = gcc_xo_dsi11_dsi01_parent_data,
		.num_parents = 3,
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_byte2_ops,
	},
...
static struct clk_rcg2 mdp_clk_src = {
	...
	.mnd_width = 0,
	.hid_width = 5,
	.parent_map = gcc_xo_gpll0_dsi0_map,
	.freq_tbl = ftbl_mdp_clk_src,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "mdp_clk_src",
		.parent_data = gcc_xo_gpll0_dsi0_parent_data,
		.num_parents = 3,
		.ops = &clk_rcg2_ops,
	},
};
...
static const struct freq_tbl ftbl_usb_fs_ic_src[] = {
	F(60000000, P_GPLL6_OUT_MAIN, 16, 0, 0),
	{ }
};

static struct clk_rcg2 usb_fs_ic_src = {
	.cmd_rcgr = 0x3F034,
	.hid_width = 5,
	.parent_map = gcc_xo_gpll6o_map,
	.freq_tbl = ftbl_usb_fs_ic_src,
	.clkr.hw.init = &(struct clk_init_data){
		.name = "usb_fs_ic_src",
		.parent_data = gcc_xo_gpll6o_parent_data,
		.num_parents = 2,
		.ops = &clk_rcg2_ops,
	},
};

static const struct freq_tbl ftbl_usb_fs_system_clk[] = {
	F(64000000, P_GPLL0_OUT_AUX, 12.5, 0, 0),
	{ }
};
...
static struct clk_rcg2 usb_fs_system_clk_src = {
	...
	.hid_width = 5,
	.parent_map = gcc_xo_gpll0_map,
	.freq_tbl = ftbl_usb_fs_system_clk,
	.clkr.hw.init = &(struct clk_init_data){
...
static struct clk_regmap *gcc_msm8917_clocks[] = {
	[GPLL0] = &gpll0.clkr,
	[GPLL0_SLEEP] = &gpll0_sleep,
	[GPLL0_VOTE] = &gpll0_vote,
	[GPLL0_AO] = &gpll0_ao.clkr,
	[GPLL0_AO_VOTE] = &gpll0_ao_vote,
	[GPLL6] = &gpll6.clkr,
	...
	[USB_FS_IC_SRC] = &usb_fs_ic_src.clkr,
	...
	[GCC_BLSP1_QUP1_SPI_APSS_CLK] = &gcc_blsp1_qup1_spi_apps_clk.clkr,
	[GCC_BLSP1_QUP2_I2C_APPS_CLK] = &gcc_blsp1_qup2_i2c_apps_clk.clkr,
	[GCC_BLSP1_QUP2_SPI_APSS_CLK] = &gcc_blsp1_qup2_spi_apps_clk.clkr,
	[GCC_BLSP1_QUP3_I2C_APPS_CLK] = &gcc_blsp1_qup3_i2c_apps_clk.clkr,
	[GCC_BLSP1_QUP3_SPI_APSS_CLK] = &gcc_blsp1_qup3_spi_apps_clk.clkr,
	[GCC_BLSP1_QUP4_I2C_APPS_CLK] = &gcc_blsp1_qup4_i2c_apps_clk.clkr,
	[GCC_BLSP1_QUP4_SPI_APSS_CLK] = &gcc_blsp1_qup4_spi_apps_clk.clkr,
	[GCC_BLSP1_UART1_APPS_CLK] = &gcc_blsp1_uart1_apps_clk.clkr,
	[GCC_BLSP1_UART2_APPS_CLK] = &gcc_blsp1_uart2_apps_clk.clkr,
	[GCC_BLSP2_AHB_CLK] = &gcc_blsp2_ahb_clk.clkr,
	[GCC_BLSP2_QUP1_I2C_APPS_CLK] = &gcc_blsp2_qup1_i2c_apps_clk.clkr,
	[GCC_BLSP2_QUP1_SPI_APSS_CLK] = &gcc_blsp2_qup1_spi_apps_clk.clkr,
	[GCC_BLSP2_QUP2_I2C_APPS_CLK] = &gcc_blsp2_qup2_i2c_apps_clk.clkr,
	[GCC_BLSP2_QUP2_SPI_APSS_CLK] = &gcc_blsp2_qup2_spi_apps_clk.clkr,
	[GCC_BLSP2_QUP3_I2C_APPS_CLK] = &gcc_blsp2_qup3_i2c_apps_clk.clkr,
	[GCC_BLSP2_QUP3_SPI_APSS_CLK] = &gcc_blsp2_qup3_spi_apps_clk.clkr,
	[GCC_BLSP2_QUP4_I2C_APPS_CLK] = &gcc_blsp2_qup4_i2c_apps_clk.clkr,
	[GCC_BLSP2_QUP4_SPI_APSS_CLK] = &gcc_blsp2_qup4_spi_apps_clk.clkr,
...
static int gcc_msm8917_probe(struct platform_device *pdev)
{
	...
	ret = qcom_cc_really_probe(pdev, &gcc_msm8917_desc, regmap);
	if (ret) {
